...
module NbE.Gluing.Interpretation
...
module _ (CCC : ContextualCartesianClosed 𝒞 𝒰) where
  ...
  open import NbE.Gluing.Categories.Functor.ContextualCartesian {𝒞 = 𝕋𝕞} {𝒟 = 𝒞}
  open import NbE.Gluing.Categories.Functor.ContextualCartesianClosed {𝒞 = 𝕋𝕞} {𝒟 = 𝒞}
