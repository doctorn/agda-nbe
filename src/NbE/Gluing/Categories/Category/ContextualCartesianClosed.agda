...
module NbE.Gluing.Categories.Category.ContextualCartesianClosed
  {o ℓ e} (𝒞 : Category o ℓ e) {a} (𝒰 : Set a) where

open import Level
open import Relation.Binary.PropositionalEquality as PE using (_≡_)
open import NbE.Gluing.Transport 𝒞

open import NbE.Gluing.Categories.Category.ContextualCartesian 𝒞 using (ContextualCartesian)
open import NbE.Gluing.Contexts 𝒰 using (𝒰ᵀ) renaming (_⇒_ to _^_)
