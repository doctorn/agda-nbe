...
module NbE.Gluing.Categories.Category.Instance.Setoids {ℓ} where
...
open import NbE.Gluing.Categories.Category.ContextualCartesian (Setoids ℓ ℓ)
open import NbE.Gluing.Categories.Category.ContextualCartesianClosed (Setoids ℓ ℓ)
