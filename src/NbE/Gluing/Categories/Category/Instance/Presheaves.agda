...
module NbE.Gluing.Categories.Category.Instance.Presheaves
  {ℓ}
  (𝒞 : Category ℓ ℓ ℓ)
  where
...
import NbE.Gluing.Categories.Category.Instance.Setoids {ℓ} as S
open import NbE.Gluing.Categories.Category.ContextualCartesian (Psh)
open import NbE.Gluing.Categories.Category.ContextualCartesianClosed (Psh)
...
module _ {a} {𝒰 : Set a} where
  ...
  open import NbE.Gluing.Contexts 𝒰 hiding (_⇒_)
