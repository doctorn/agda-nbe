...
module NbE.Gluing.Glue.Base {a} (𝒰 : Set a) where
...
open import NbE.Gluing.Categories.Functor.Properties using (precompose)

open import NbE.Gluing.Contexts 𝒰
open import NbE.Gluing.Weakenings 𝒰 using (𝕎; ⟦_⟧; ω₁; ω₂; 𝒲)
