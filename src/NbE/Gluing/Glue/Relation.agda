...
module NbE.Gluing.Glue.Relation {a} (𝒰 : Set a) where
...
open import NbE.Gluing.Glue.Yoga 𝒰 hiding (ϕ)
open import NbE.Gluing.Glue.CartesianClosed 𝒰

import NbE.Gluing.Interpretation 𝒰 as Interpretation
...
open import NbE.Gluing.Weakenings 𝒰 using (𝕎; ω₁; ϵ)
import NbE.Gluing.Representation 𝒰 as R
open import NbE.Gluing.Categories.Category.Instance.Presheaves 𝕎 as Psh using (Psh)
open import NbE.Gluing.Categories.Category.Instance.Setoids {a} as Setoids using (Setoids)
open import NbE.Gluing.Categories.Category.ContextualCartesianClosed
open import NbE.Gluing.Categories.Functor.ContextualCartesian
open import NbE.Gluing.Categories.Functor.ContextualCartesianClosed
open import NbE.Gluing.Categories.Functor.Instance.Identity hiding (id)
open import NbE.Gluing.Categories.Functor.Instance.Composite

open import NbE.Gluing.Transport
open import NbE.Gluing.Transport.Functor
