...
module NbE.Gluing.Glue.CartesianClosed {a} (𝒰 : Set a) where
...
open import NbE.Gluing.Glue.Cartesian 𝒰
open import NbE.Gluing.Glue.Lambda 𝒰
open import NbE.Gluing.Glue.Eval 𝒰 using (eval; eval′)
open import NbE.Gluing.Glue.Yoga 𝒰 using (↓₀; ↑₀; ϕ; ψ; 𝓡₀; yoga₀)

open import NbE.Gluing.Weakenings 𝒰 using (𝕎; ϵ; ω₁)
open import NbE.Gluing.Embedding 𝒰
open import NbE.Gluing.Contexts 𝒰 using (ℭ; 𝒰ᵀ) renaming (_⇒_ to _^_)
