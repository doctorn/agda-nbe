...
∘-assoc : ∀ {Γ₁ Γ₂ Γ₃ Γ₄} (w₁ : 𝒲 Γ₁ Γ₂) (w₂ : 𝒲 Γ₂ Γ₃) (w₃ : 𝒲 Γ₃ Γ₄)
          → (w₃ ∘ w₂) ∘ w₁ ≡ w₃ ∘ (w₂ ∘ w₁)
∘-assoc ϵ₀      w₂      w₃      = PE.refl
...
∘-sym-assoc : ∀ {Γ₁ Γ₂ Γ₃ Γ₄} (w₁ : 𝒲 Γ₁ Γ₂) (w₂ : 𝒲 Γ₂ Γ₃) (w₃ : 𝒲 Γ₃ Γ₄)
              → w₃ ∘ (w₂ ∘ w₁) ≡ (w₃ ∘ w₂) ∘ w₁
...
module _ {ℓ e} (𝒞 : Category a ℓ e) where
  ...
  module _ (CC : ContextualCartesian (𝒰 ᵀ)) where
    ...
    ⟦_⟧-homomorphism : ∀ {Γ₁ Γ₂ Γ₃} {w₁ : 𝒲 Γ₁ Γ₂} {w₂ : 𝒲 Γ₂ Γ₃}
                      → ⟦ w₂ 𝕎.∘ w₁ ⟧₁ ≈ ⟦ w₂ ⟧₁ 𝒞.∘ ⟦ w₁ ⟧₁
